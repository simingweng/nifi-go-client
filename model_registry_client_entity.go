...
type NullableRegistryClientEntity struct {
	value *RegistryClientEntity
	isSet bool
}

func (v NullableRegistryClientEntity) Get() *RegistryClientEntity {
	return v.value
}

func (v *NullableRegistryClientEntity) Set(val *RegistryClientEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistryClientEntity) IsSet() bool {
	return v.isSet
}
...
func NewNullableRegistryClientEntity(val *RegistryClientEntity) *NullableRegistryClientEntity {
	return &NullableRegistryClientEntity{value: val, isSet: true}
}
