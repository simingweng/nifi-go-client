...
type NullableParameterContextEntity struct {
	value *ParameterContextEntity
	isSet bool
}

func (v NullableParameterContextEntity) Get() *ParameterContextEntity {
	return v.value
}

func (v *NullableParameterContextEntity) Set(val *ParameterContextEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableParameterContextEntity) IsSet() bool {
	return v.isSet
}
...
func NewNullableParameterContextEntity(val *ParameterContextEntity) *NullableParameterContextEntity {
	return &NullableParameterContextEntity{value: val, isSet: true}
}
